...
if menu == "➕ Novo Nutribook":
    ...
    if df_dados is not None and not df_dados.empty:
        ...
        c_whatsapp = next((c for c in df_exibicao.columns if 'whatsapp' in c.lower() or 'celular' in c.lower() or 'telefone' in c.lower()), None)
        ...
        if c_whatsapp: mapa_colunas[c_whatsapp] = "WhatsApp do Paciente"
    ...
    st.write("Gerencie a conexão da Evolution API para disparos automáticos de mensagens.")
    st.divider()
    ...
    try:
        ...
        if res_state.status_code == 200:
            ...
            if status_atual == "open":
                ...
                st.info("Sua instância está pronta para enviar o Nutribook automaticamente aos pacientes.")
            else:
